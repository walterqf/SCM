Public Class frm_autorizacion_orden_ingreso
    ...
    Private Sub cargar_ordenes_pendientes()
        ...
        data_tmp = BO.BOGeneral.GetAll_ordenes_empresa_estado(vCon, Convert.ToInt32(cmb_empresa.SelectedValue), 1, 2)
    ...
    Private Sub frm_autorizacion_orden_ingreso_Load(sender As Object, e As EventArgs) Handles Me.Load

Public Class frm_reporte_ordenes
    ...
    Private Sub cargar_ordenes_pendientes()
        ...
        data_tmp = BO.BOGeneral.GetAll_ordenes_empresa_estado_inv(vCon, Convert.ToInt32(cmb_empresa.SelectedValue), Convert.ToInt32(cmb_estado.SelectedValue), Convert.ToInt32(cmb_tipo_orden.SelectedValue))
    ...
    Private Sub frm_reporte_ordenes_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub cargar_tipo()
        Dim iDTipo As DataTable
        iDTipo = BO.BOtbl_tipo_orden.getAll(vCon, New Entity.tbl_tipo_orden_Entity)
        cmb_tipo_orden.Items.Clear()
        cmb_tipo_orden.DataSource = iDTipo
        cmb_tipo_orden.DisplayMember = "descripcion_orden"
        cmb_tipo_orden.ValueMember = "id_tipo_orden"
    End Sub

    Private Sub cargar_estado()
        Dim iDEstado As DataTable
        iDEstado = BO.BOtbl_estado_orden.getAll(vCon, New Entity.tbl_estado_orden_Entity)
        cmb_estado.Items.Clear()
        cmb_estado.DataSource = iDEstado
        cmb_estado.DisplayMember = "nombre_estado_orden"
        cmb_estado.ValueMember = "id_estado_orden"
    End Sub
    ...
    Private Sub cmb_tipo_orden_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles cmb_tipo_orden.SelectionChangeCommitted
        cargar_ordenes_pendientes()
    End Sub
